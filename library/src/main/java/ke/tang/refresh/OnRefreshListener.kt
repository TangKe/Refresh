...
interface OnRefreshListener {
     ...
     * when [RefreshLayout] refreshAxis set as horizontal, [isHeader] true means from left, otherwise means from right
     */
     ...
     */
    fun onRefreshComplete(observable: RefreshObservable): Boolean = false
}